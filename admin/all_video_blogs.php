      ...
      <div class="container-fluid body-section">
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <?php        
            $query =  " SELECT * FROM video_blogs ORDER BY id DESC";
            ...
            ?>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                     <a href="video_blog_edit.php?id=<?php echo $id;?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                  </td>
           ...
           <?php  } ?>
            ...
            <a href="video_blogs.php" class="btn btn-primary mb-3">ADD New Post</a>
